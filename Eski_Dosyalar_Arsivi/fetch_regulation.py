...
url = "https://www.mevzuat.gov.tr/MevzuatMetin/7.5.17339.pdf"
file_path = "17339_yonetmelik.pdf"
...
print(f"Extracted {len(articles)} regulation articles and saved to src/data/regulation_articles.json.")
