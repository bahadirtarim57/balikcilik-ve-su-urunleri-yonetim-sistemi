...
pdf_path = r"C:\Users\Bahadır\Desktop\Bahadır\Yeni klasör (3)\Tebliğ6.1.pdf"
...
pattern = re.compile(r'(MADDE\s+(\d+)\s*[-—].*?)(?=MADDE\s+\d+\s*[-—]|$)', re.DOTALL)
...
print(f"Extracted {len(articles)} articles from 6.1.")