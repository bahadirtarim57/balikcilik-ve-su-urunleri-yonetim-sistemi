...
import { Droplets, ArrowLeft, Save, Calendar, Anchor, LifeBuoy } from 'lucide-react';
import { toast } from 'react-hot-toast';

const YeniIcsuRuhsatiFormu = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('İçsu Ruhsat Form Verileri:', formData);
    toast.success('İçsu ruhsat kaydı başarıyla oluşturuldu!');
  };

  // Form inputları için yardımcı bileşen (Mavi temalı focus)
  ...
  return (
    <div style={{ padding: '40px 40px', maxWidth: '1200px', margin: '0 auto', animation: 'fadeIn 0.5s ease-out' }}>
      ...
      <div style={{ background: 'white', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0,0,0,0.08)', overflow: 'hidden' }}>
        ...
        {/* Üst Kısım / Başlık */}
        <div style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)', padding: '30px 40px', color: 'white', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', position: 'relative', zIndex: 1 }}>
            ...
            <div>
              <h2 style={{ fontSize: '26px', fontWeight: '800', margin: 0, letterSpacing: '1px' }}>İÇSU RUHSAT KAYDI</h2>
              <p style={{ margin: '6px 0 0 0', color: 'rgba(255,255,255,0.9)', fontSize: '15px' }}>Göl, baraj ve nehir tekneleri için yeni ruhsat bilgilerini eksiksiz doldurunuz.</p>
            </div>
          </div>
        </div>
...
export default YeniIcsuRuhsatiFormu;
